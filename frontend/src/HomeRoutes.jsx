...
import UserPlay from "./users/UserPlay.jsx"
...
<Route path="/userplay" element={<Protected><UserPlay /></Protected>} />
<Route path="/userscore" element={<Protected><UserScore /></Protected>} />
