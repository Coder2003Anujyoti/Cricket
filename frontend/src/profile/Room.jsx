...
<HashLink smooth to={`/onlinedual?id=${encodeURIComponent(name)}&&player=${encodeURIComponent(i.player)}&&playerteam=${encodeURIComponent(i.playerteam)}&&computerteam=${encodeURIComponent(i.computerteam)}&&computer=${encodeURIComponent(i.computer)}`}>
