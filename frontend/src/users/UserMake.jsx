...
<div className="w-full p-2 px-3 justify-start items-start flex flex-row gap-4 flex-wrap">
...
<div className="w-full px-3 p-2 justify-start items-start flex flex-row gap-4 flex-wrap">
  ...
  }
{
  loading==false && show==false && <>
    <div className="flex justify-center items-center my-40 px-4">
      <div className="bg-slate-700 shadow-lg rounded-2xl p-8 max-w-md w-full text-center">
        <MdWarningAmber className="text-6xl text-yellow-400 mx-auto mb-4" />
        <h2 className="text-2xl font-bold text-white mb-2">
          Access Restricted
        </h2>
        <p className="text-gray-600">
          <span className="font-bold text-sky-400">Game is Live</span>.
        </p>
      </div>
    </div>
  </>
