...
const barChartData = {
 ...
 stand.push({name:i,matches:matches,win:wins,lose:matches-(wins+draw),draw:draw})
  ...
  >
    Welcome to Ultimate Cricket League!
  </motion.h1>
 ...
 <div className="w-full text-center flex mx-auto p-4  gap-2 overflow-hidden">
    ...
    <div className="w-full py-4 flex-col items-center flex-wrap flex  justify-center"><button onClick={localremove} className="text-sm  text-white font-bold px-4 py-3 bg-sky-600 rounded-md">New Tournament</button></div>
  </div>
